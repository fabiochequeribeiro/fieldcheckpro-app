...
export default function App() {
  ...
  async function loadData() {
    setLoading(true);
    setMessage('');
    const [orderResult, techResult, modelResult, visitResult, auditResult] = await Promise.all([
    ...
    const error = orderResult.error || techResult.error || modelResult.error || visitResult.error;
