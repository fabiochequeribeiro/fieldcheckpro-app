...
const empresas = [
  { nome: 'FieldCheck', codigo: 'FieldCheck' },
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          <img src="/logo.png" alt="FieldCheck" style={styles.logo} />

          <div>
            <h1 style={styles.titulo}>DASHBOARD FIELDCHECK</h1>
...
<div style={styles.graficosHomeGrid}>
  ...
  <div style={styles.graficoHomeCard}>
    <h2 style={styles.graficoTitulo}>�x` Pedidos por Mês</h2>
...
/>
  ...
  <div style={styles.graficoHomeCard}>
    <h2 style={styles.graficoTitulo}>�x�  Equipamentos Mais Vendidos</h2>
      ...
      <div style={styles.headerLeft}>
        ...
        <div>
          ...
          <p style={styles.atualizacao}>
            <RefreshCcw size={18} /> �altima atualização: {ultimaAtualizacao}
          </p>
        </div>
      </div>
