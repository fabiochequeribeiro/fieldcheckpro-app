...
export default function VisitaTecnicaView() {
  ...
  const podeAlterarEstrutura = usuarioPodeGerenciar();
        ...
        <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          >
            ...
            <Secao titulo="Dados do cliente e da visita">
              ...
              <Campo label="Cliente" value={dados.cliente} onChangeText={(v) => atualizarCampo('cliente', v)} editable={podeAlterarEstrutura} />
              <Campo label="Endereço" value={dados.endereco} onChangeText={(v) => atualizarCampo('endereco', v)} editable={podeAlterarEstrutura} />
              <Campo label="Cidade" value={dados.cidade} onChangeText={(v) => atualizarCampo('cidade', v)} editable={podeAlterarEstrutura} />
              <Campo label="Estado" value={dados.estado} onChangeText={(v) => atualizarCampo('estado', v)} editable={podeAlterarEstrutura} />
              <Campo label="Telefone" value={dados.telefone} onChangeText={(v) => atualizarCampo('telefone', v)} editable={podeAlterarEstrutura} />
              <Campo label="E-mail do cliente" value={dados.emailCliente} onChangeText={(v) => atualizarCampo('emailCliente', v)} editable={podeAlterarEstrutura} />
              <Campo label="Responsável" value={dados.responsavel} onChangeText={(v) => atualizarCampo('responsavel', v)} editable={podeAlterarEstrutura} />
              <Campo label="Técnico responsável" value={dados.tecnico} onChangeText={(v) => atualizarCampo('tecnico', v)} editable={podeAlterarEstrutura} />
              <Campo label="Data" value={dados.data} onChangeText={(v) => atualizarCampo('data', v)} editable={podeAlterarEstrutura} />
            </Secao>
