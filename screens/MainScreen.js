...
export default function MainScreen({ navigation, usuarioLogado, acessoComercial, configuracaoModular, trialAccess, onLogout, resumoHome = {} }) {
  ...
  const acoesRapidasBase = [
    ...
    {
      titulo: 'Nova venda',
      descricao: 'Lead, proposta e follow-up',
      icone: 'briefcase',
      rota: 'Comercial',
      modulo: MODULOS.COMERCIAL,
      cor: '#0f766e',
      fundo: '#e6fffb',
    },
  ];
  ...
  const atalhosBase = [
    ...
    {
      titulo: 'Comercial',
      descricao: 'Controlar leads, propostas, visitas comerciais e follow-up.',
      icone: 'briefcase',
      rota: 'Comercial',
      modulo: MODULOS.COMERCIAL,
      cor: '#0f766e',
    ...
    {
      titulo: 'Equipamentos vendidos',
      descricao: 'Historico por maquina: venda, entrega, preventiva, corretiva, pecas e PDFs.',
      icone: 'construct',
      rota: 'Equipamentos',
      modulo: MODULOS.INVENTARIO,
      cor: '#123c69',
    ...
    },
    {
      ...
      descricao: 'Planos por maquina, serie, horimetro, prazo e recorrencia.',
      icone: 'calendar',
      rota: 'Preventivas',
      modulo: MODULOS.MANUTENCAO_PREVENTIVA,
      cor: '#1f7ae0',
      fundo: '#eaf3ff',
    },
    {
